...
export const metadata: Metadata = {
  ...
  description: 'Upcoming events and networking opportunities at The Nexus Hub.',
}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Connect, learn, and grow at our community events and workshops.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-display font-semibold text-gray-600 mb-2 uppercase tracking-wide">No Events Yet</h2>
