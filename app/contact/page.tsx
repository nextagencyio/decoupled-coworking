...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with The Hive Coworking.',
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about The Hive Coworking? We&#39;d love to hear from you.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Main Street<br />Suite 100<br />San Francisco, CA 94105</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <form className="space-y-6">
                ...
                <button type="submit" className="w-full bg-amber-700 text-white py-3 px-4 rounded-md hover:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-700 focus:ring-offset-2 transition-colors duration-200 font-medium">
                  Send Message
                </button>
              </form>
            </div>
